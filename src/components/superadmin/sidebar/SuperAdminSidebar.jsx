...
function SupersuperadminSidebar() {
  ...
  const menuItems = [
    { icon: <HiOutlineUsers />, text: "Clients", path: "/Supersuperadmin/clients" },
    { icon: <RiUser3Line />, text: "Profile", path: "/Supersuperadmin/profile" },
  ];
...
export default SupersuperadminSidebar;
