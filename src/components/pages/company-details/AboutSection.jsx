          ...
          <div key={section.id} className="bg-white rounded-lg overflow-hidden">
            ...
            >
                {section.content.introduction ? (
                  <div className="space-y-4">
                    <p className="text-gray-900 text-sm font-medium leading-7 tracking-[0.03em]">
                      {section.content.introduction}
                    </p>
                    <div className="space-y-4">
                      {section.content.points.map((item, index) => (
                        <div key={index} className="flex items-center gap-6">
                          ...
                          <div className="flex-1">
                            <span className="font-semibold text-sm tracking-[0.03em] text-gray-900">
                              {item.title}:
                            </span>
                  ...
                  <div className="space-y-4">
                    {Array.isArray(section.content) ? (
                      ...
                      <p className="text-neutral-500 text-sm font-medium leading-7 tracking-[0.03em] whitespace-pre-line">
                        {section.content}
                      </p>
                    )}
                  </div>
