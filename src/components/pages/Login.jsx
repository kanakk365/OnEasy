...
function Login() {
  ...
  const handleAppleLogin = async () => {
    ...
    try {
      ...
      const result = await apiClient.appleLogin({
        ...
        {isSignupMode ? (
          ...
          <form onSubmit={handleSignup} className="space-y-5">
            ...
            <div>
              ...
              <div className="flex gap-2">
                <div className="w-16 sm:w-20 h-12 bg-gray-100 rounded-lg flex items-center justify-center text-sm font-medium text-gray-500 shrink-0">
                  {countryCode}
                </div>
                <input
                  type="tel"
                  ...
                  maxLength="10"
                  className="flex-1 min-w-0 h-12 px-4 rounded-lg bg-gray-100 border-none focus:ring-2 focus:ring-[#022B51] placeholder-gray-400 text-sm transition-all"
                  disabled={isLoading}
                />
              </div>
            </div>
          ...
          <>
              ...
              !isOtpStep ? (
                ...
                <form onSubmit={handlePhoneLogin} className="space-y-6">
                  <div>
                    ...
                    <div className="flex gap-2">
                      <div className="w-16 sm:w-20 h-12 bg-gray-100 rounded-lg flex items-center justify-center text-sm font-medium text-gray-600 shrink-0">
                        {countryCode}
                      </div>
                      <input
                        type="tel"
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full h-12 bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-medium rounded-lg transition-colors flex items-center justify-center gap-3 mt-3"
            >
              <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                <path d="M17.05 20.28c-.98.95-2.05.88-3.08.4-1.09-.5-2.08-.48-3.24 0-1.44.62-2.2.44-3.06-.4C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z"/>
              </svg>
              <span className="text-gray-600">Sign in with Apple</span>
            </button>
          </>
        )}
      </div>
