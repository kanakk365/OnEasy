...
function HousePropertyITRDetails() {
  const navigate = useNavigate();
  const [activeTab, setActiveTab] = useState('packages');
  const [expandedSection, setExpandedSection] = useState(null);
  const [showPaymentPopup, setShowPaymentPopup] = useState(false);

  const { packages, loading: packagesLoading } = usePackages('house-property-itr');
        ...
        return (
          <PackagesSection
            ...
            onGetStarted={async (selectedPackage) => {
              try {
                localStorage.setItem('selectedRegistrationType', 'house-property-itr');
                localStorage.setItem('selectedRegistrationTitle', 'House Property - Income Tax Return');
                ...
                if (result.success) {
                  if (result.showPopup) {
                    ...
                    navigate('/tax-accounting/house-property-itr-form');
                  }
                }
              } catch (error) {
...
export default HousePropertyITRDetails;
