...
function PartnershipFirmITRDetails() {
  const navigate = useNavigate();
  const [activeTab, setActiveTab] = useState('packages');
  const [expandedSection, setExpandedSection] = useState(null);
  const [showPaymentPopup, setShowPaymentPopup] = useState(false);

  const { packages, loading: packagesLoading } = usePackages('partnership-firm-itr');
  ...
  const prerequisites = [
    ...
    { title: 'Income Details', description: 'Information on all income sources of the partnership Firm(salary, business, rental, interest)' },
    ...
    { title: 'Accounting data of the partnership firm.', description: '' },
        ...
        return (
          <PackagesSection
            ...
            onGetStarted={async (selectedPackage) => {
              try {
                localStorage.setItem('selectedRegistrationType', 'partnership-firm-itr');
                ...
                if (result.success) {
                  if (result.showPopup) {
                    ...
                    navigate('/tax-accounting/partnership-firm-itr-form');
                  }
                }
              } catch (error) {
...
export default PartnershipFirmITRDetails;
