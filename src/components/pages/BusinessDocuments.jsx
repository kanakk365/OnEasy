                ...
                {organizationDocuments.map((doc, index) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="px-4 py-2 text-sm font-medium text-[#022B51] border border-[#022B51] rounded-md hover:bg-[#015079] hover:text-white transition-colors flex-shrink-0 ml-2"
                    >
                      View
                    </button>
                  </div>
