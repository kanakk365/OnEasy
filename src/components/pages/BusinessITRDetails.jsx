...
function BusinessITRDetails() {
  const navigate = useNavigate();
  const [activeTab, setActiveTab] = useState('packages');
  const [expandedSection, setExpandedSection] = useState(null);
  const [showPaymentPopup, setShowPaymentPopup] = useState(false);

  const { packages, loading: packagesLoading } = usePackages('business-itr');
        ...
        return (
          <PackagesSection
            ...
            onGetStarted={async (selectedPackage) => {
              try {
                localStorage.setItem('selectedRegistrationType', 'business-itr');
                localStorage.setItem('selectedRegistrationTitle', 'Business - Income Tax Return');
                ...
                if (result.success) {
                  if (result.showPopup) {
                    ...
                    navigate('/tax-accounting/business-itr-form');
                  }
                }
              } catch (error) {
...
export default BusinessITRDetails;
