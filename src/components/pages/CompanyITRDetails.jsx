...
function CompanyITRDetails() {
  const navigate = useNavigate();
  const [activeTab, setActiveTab] = useState('packages');
  const [expandedSection, setExpandedSection] = useState(null);
  const [showPaymentPopup, setShowPaymentPopup] = useState(false);

  const { packages, loading: packagesLoading } = usePackages('company-itr');
  ...
  const documents = [
    ...
    'Accounting Details of the firm'
  ];

  const prerequisites = [
    { title: 'PAN Card', description: 'Mandatory for filing your ITR.' },
    { title: 'Income Details', description: 'Information on all income sources of the company Firm(salary, business, rental, interest)' },
    { title: 'Bank Statements', description: 'Confirm interest income and relevant transactions.' },
    { title: 'Investment Proofs', description: 'Receipts for deductions' },
    ...
    { title: 'Accounting data of the Company.', description: '' },
        ...
        return (
          <PackagesSection
            ...
            onGetStarted={async (selectedPackage) => {
              try {
                localStorage.setItem('selectedRegistrationType', 'company-itr');
                localStorage.setItem('selectedRegistrationTitle', 'Company - ITR');
                ...
                if (result.success) {
                  if (result.showPopup) {
                    ...
                    navigate('/tax-accounting/company-itr-form');
                  }
                }
              } catch (error) {
...
export default CompanyITRDetails;
