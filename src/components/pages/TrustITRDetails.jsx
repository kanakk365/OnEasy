...
function TrustITRDetails() {
  const navigate = useNavigate();
  const [activeTab, setActiveTab] = useState('packages');
  const [expandedSection, setExpandedSection] = useState(null);
  const [showPaymentPopup, setShowPaymentPopup] = useState(false);

  const { packages, loading: packagesLoading } = usePackages('trust-itr');
        ...
        return (
          <PackagesSection
            ...
            onGetStarted={async (selectedPackage) => {
              try {
                localStorage.setItem('selectedRegistrationType', 'trust-itr');
                localStorage.setItem('selectedRegistrationTitle', 'Trust - Income Tax Return');
                ...
                if (result.success) {
                  if (result.showPopup) {
                    ...
                    navigate('/tax-accounting/trust-itr-form');
                  }
                }
              } catch (error) {
...
export default TrustITRDetails;
