  ...
  const aboutSections = [
    {
      ...
      title: "About Partnership Firm",
      content:
        "A Partnership Firm is a favored choice among entrepreneurs for its simplicity and flexibility. It allows multiple individuals to pool their resources, skills, and expertise to run a business. This model allows for flexibility in management and profit-sharing, tailored to the partners' agreement. Partnerships benefit from relatively easy formation and fewer regulatory requirements compared to corporations."
    },
    {
    ...
    },
    {
      ...
      content:
        "Partnership firm registration involves the formal recognition of the partnership by the Registrar of Firms in the state where the firm operates. Although registration is optional, it is highly recommended as it provides legal recognition and protection.\n\nTo register a partnership firm, at least two individuals must come together, agree on a firm name, and prepare a partnership deed."
    },
    {
