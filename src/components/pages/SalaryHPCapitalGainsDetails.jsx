...
function SalaryHPCapitalGainsDetails() {
  const navigate = useNavigate();
  const [activeTab, setActiveTab] = useState('packages');
  const [expandedSection, setExpandedSection] = useState(null);
  const [showPaymentPopup, setShowPaymentPopup] = useState(false);

  const { packages, loading: packagesLoading } = usePackages('salary-hp-capital-gains');

  const processSteps = [
    { step: 1, title: 'Login to the Portal', description: 'Visit the Income Tax Department e-filing website.' },
    { step: 2, title: 'Select the Right ITR Form', description: 'Choose the form based on your income sources.' },
    { step: 3, title: 'Complete and Submit', description: 'Fill in the necessary details and submit your ITR.' },
    { step: 4, title: 'E-Verify Your Return', description: 'After submission, verify your return to complete the process.' }
  ];
  ...
  const prerequisites = [
    { title: 'PAN Card', description: 'Mandatory for filing your ITR.' },
    { title: 'Income Details', description: 'Information on all income sources (salary, business, rental, interest).' },
    { title: 'Form 16/16A', description: 'Obtain from your employer for salary details and TDS.' },
    { title: 'Bank Statements', description: 'Confirm interest income and relevant transactions.' },
    { title: 'Investment Proofs', description: 'Receipts for deductions (Sections 80C, 80D, etc.).' },
    { title: 'Previous Year\'s ITR', description: 'Reference for consistency in reporting.' },
    { title: 'Tax Payment Receipts', description: 'Records of advance tax and self-assessment payments.' },
    { title: 'Aadhaar Number', description: 'Mandatory linkage with PAN for filing.' },
    { title: 'Other Relevant Documents', description: 'Capital gains statements, foreign income details, etc.' }
  ];
  ...
  const faqs = [
    { question: 'What is ITR e-filing?', answer: 'ITR e-filing refers to the electronic submission of your Income Tax Return through the Income Tax Department\'s online portal. It allows taxpayers to report their income, deductions, and tax liabilities conveniently.' },
    { question: 'Who is required to e-file an Income Tax Return?', answer: 'Individuals, Hindu Undivided Families (HUFs), firms, companies, and other entities with income exceeding the basic exemption limit are required to e-file their ITR. Specific conditions apply based on income sources and categories.' },
    { question: 'What documents do I need for ITR e-filing?', answer: 'Essential documents include your PAN, Aadhaar number, bank account details, salary slips, Form 16, Form 26AS, and proof of deductions or tax-saving investments.' },
    { question: 'What are the different ITR forms available?', answer: 'There are several ITR forms, including ITR-1 (SAHAJ), ITR-2, ITR-3, ITR-4, ITR-5, ITR-6, and ITR-7. The choice of form depends on your income sources and taxpayer status.' },
    { question: 'What is the deadline for e-filing ITR for AY 2024-25?', answer: 'The deadline for e-filing ITR for individuals and non-audit entities is July 31, 2024. For taxpayers under audit, it is October 31, 2024, and for those covered under transfer pricing, it is November 30, 2024.' },
    { question: 'Can I file my ITR after the deadline?', answer: 'Yes, you can file a belated return after the deadline, but it may incur penalties, and you will miss out on some benefits, such as carrying forward losses.' },
    { question: 'How can I e-file my ITR?', answer: 'To e-file your ITR, visit the Income Tax Department\'s e-filing portal, log in, select the appropriate ITR form, fill in the required details, and submit your return. Don\'t forget to e-verify your return.' },
    { question: 'What are the penalties for late ITR filing?', answer: 'If you miss the filing deadline, you may face a penalty of up to ₹5,000 (or ₹1,000 if your income is below ₹5 lakh) and interest on unpaid taxes at the rate of 1% per month under Section 234A.' },
    { question: 'How can I claim a tax refund through e-filing?', answer: 'To claim a tax refund, you need to e-file your ITR accurately, reflecting your income and tax payments. The refund will be processed by the Income Tax Department once your return is verified.' },
    { question: 'Is it safe to e-file my ITR?', answer: 'Yes, e-filing is safe and secure. The Income Tax Department uses encryption and other security measures to protect taxpayer information during the e-filing process.' }
  ];
        ...
        return (
          <PackagesSection
            ...
            onGetStarted={async (selectedPackage) => {
              try {
                localStorage.setItem('selectedRegistrationType', 'salary-hp-capital-gains');
                localStorage.setItem('selectedRegistrationTitle', 'Income From Salary, HP and Capital gains');
                ...
                if (result.success) {
                  if (result.showPopup) {
                    ...
                    navigate('/tax-accounting/multi-income-itr-form');
                  }
                }
              } catch (error) {
      ...
      case 'about':
        return (
          <AboutSection
            ...
            introDescription="Filing Income Tax Returns (ITR) is a fundamental obligation for every taxpayer in India."
          />
        );
      case 'faq':
...
export default SalaryHPCapitalGainsDetails;
