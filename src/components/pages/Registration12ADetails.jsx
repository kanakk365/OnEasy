  ...
  const packages = [
    {
      ...
      priceValue: 7499,
      period: 'One Time',
      description: 'Basic 12A registration package',
      icon: '★',
      features: [
        'Form 12A Application',
        'Form 12A Temporary Registration'
      ],
      color: 'blue'
    },
    {
      ...
      priceValue: 17499,
      period: 'One Time',
      description: 'Complete 12A and 80G registration package',
      icon: '✢',
      features: [
        'Form 12A Application',
        'Form 12A Temporary Registration',
        '80G Application',
        '80G Temporary Registration'
      ],
      isHighlighted: true,
      color: 'blue'
    }
