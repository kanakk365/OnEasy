        ...
        {showNavigationButtons && (
          <div className="flex justify-between items-center max-w-3xl mx-auto mt-8 mb-8">
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 text-white rounded-lg hover:opacity-90 transition-all" style={{ background: "linear-gradient(180deg, #022B51 0%, #015079 100%)" }}
            >
