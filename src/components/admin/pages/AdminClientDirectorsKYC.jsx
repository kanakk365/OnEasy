...
function AdminClientDirectorsKYC() {
  ...
  // Render icon component (same as BusinessDirectorsKYC)
  ...
  const loadClientAndDocuments = async () => {
    try {
      ...
      // Fetch directors/partners documents for this organization
...
export default AdminClientDirectorsKYC;
