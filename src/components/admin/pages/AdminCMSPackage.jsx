...
function AdminCMSPackage() {
  ...
  const serviceTypes = [
    ...
    { value: 'professional-tax-return', label: 'Professional Tax Return Filing' },
    ...
    { value: 'house-property-itr', label: 'House Property - Income Tax Return' },
    { value: 'trust-itr', label: 'Trust - Income Tax Return' },
    { value: 'salary-hp-capital-gains', label: 'Income From Salary, HP and Capital gains' },
